...
public class TimeSeriesChartFXDemo1 extends Application {
    private static JFreeChart createChart ( final XYDataset dataset ) {
        final JFreeChart chart = ChartFactory.createTimeSeriesChart ( "International Coffee Organisation : Coffee Prices", null, "US cents/lb", dataset );
        ...
        if ( r instanceof XYLineAndShapeRenderer ) {
            ...
            renderer.setBaseStroke ( new BasicStroke ( 3.0f, 1, 2 ), false );
    ...
    private static XYDataset createDataset() {
        final TimeSeries s1 = new TimeSeries ( "Indicator Price" );
        ...
        final TimeSeries s3 = new TimeSeries ( "Other Milds" );
        s3.add ( new Month ( 1, 2010 ), 158.9 );
        s3.add ( new Month ( 2, 2010 ), 157.86 );
        s3.add ( new Month ( 3, 2010 ), 164.5 );
        ...
        final TimeSeries s4 = new TimeSeries ( "Brazilian Naturals" );
        ...
        final TimeSeries s5 = new TimeSeries ( "Robustas" );
        ...
        final TimeSeries s6 = new TimeSeries ( "Futures (London)" );
        ...
        final TimeSeries s7 = new TimeSeries ( "Futures (New York)" );
