...
public class GradientXYBarPainter implements XYBarPainter, Serializable {
    ...
    public GradientXYBarPainter ( final double g1, final double g2, final double g3 ) {
        this.g1 = g1;
        this.g2 = g2;
        this.g3 = g3;
    }
    ...
    public void paintBar ( final Graphics2D g2, final XYBarRenderer renderer, final int row, final int column, final RectangularShape bar, final RectangleEdge base ) {
        ...
        if ( base == RectangleEdge.TOP || base == RectangleEdge.BOTTOM ) {
            ...
            GradientPaint gp2 = new GradientPaint ( 0.0f, ( float ) regions[0].getMinY(), c0, 0.0f, ( float ) regions[0].getMaxX(), Color.white );
            g2.setPaint ( gp2 );
            g2.fill ( regions[0] );
    ...
    public boolean equals ( final Object obj ) {
        ...
        final GradientXYBarPainter that = ( GradientXYBarPainter ) obj;
