...
public class IntervalXYItemLabelGenerator extends AbstractXYItemLabelGenerator implements XYItemLabelGenerator, Cloneable, PublicCloneable, Serializable {
    ...
    public IntervalXYItemLabelGenerator ( final String formatString, final NumberFormat xFormat, final NumberFormat yFormat ) {
        super ( formatString, xFormat, yFormat );
    }
    public IntervalXYItemLabelGenerator ( final String formatString, final DateFormat xFormat, final NumberFormat yFormat ) {
        super ( formatString, xFormat, yFormat );
    }
    public IntervalXYItemLabelGenerator ( final String formatString, final NumberFormat xFormat, final DateFormat yFormat ) {
        super ( formatString, xFormat, yFormat );
    }
    public IntervalXYItemLabelGenerator ( final String formatString, final DateFormat xFormat, final DateFormat yFormat ) {
        super ( formatString, xFormat, yFormat );
    }
    @Override
    ...
    public boolean equals ( final Object obj ) {
        return obj == this || ( obj instanceof IntervalXYItemLabelGenerator && super.equals ( obj ) );
    }
}
