...
public final class SSL {
    ...
    public static native int fipsModeSet ( final int p0 ) throws Exception;
    ...
    public static native void setBIO ( final long p0, final long p1, final long p2 );
    public static native int getError ( final long p0, final int p1 );
    public static native int pendingWrittenBytesInBIO ( final long p0 );
    public static native int pendingReadableBytesInSSL ( final long p0 );
    public static native int writeToBIO ( final long p0, final long p1, final int p2 );
    public static native int readFromBIO ( final long p0, final long p1, final int p2 );
    ...
    public static native long makeNetworkBIO ( final long p0 );
