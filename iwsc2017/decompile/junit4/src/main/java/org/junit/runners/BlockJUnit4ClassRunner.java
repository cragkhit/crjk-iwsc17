...
public class BlockJUnit4ClassRunner extends ParentRunner<FrameworkMethod> {
    ...
    public BlockJUnit4ClassRunner ( final Class<?> testClass ) throws InitializationError {
        super ( testClass );
    ...
    protected Object createTest ( final FrameworkMethod method ) throws Exception {
    ...
    private Statement withMethodRules ( final FrameworkMethod method, final List<TestRule> testRules, final Object target, final Statement result ) {
