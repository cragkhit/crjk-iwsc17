...
public class Theories extends BlockJUnit4ClassRunner {
    ...
    private void validateDataPointFields ( final List<Throwable> errors ) {
        ...
        final Field[] fields = declaredFields = this.getTestClass().getJavaClass().getDeclaredFields();
    ...
    private void validateDataPointMethods ( final List<Throwable> errors ) {
        ...
        final Method[] methods = declaredMethods = this.getTestClass().getJavaClass().getDeclaredMethods();
